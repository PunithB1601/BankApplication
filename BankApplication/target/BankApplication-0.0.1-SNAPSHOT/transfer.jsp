...
if(c!=null){%>
    <div class="login-container container">
    	...
    	<div class="alert alert-danger" role="alert">
  		...
  		<%}%>
  		 	<div class="mb-3">
                <input type="text" class="form-control" name="accountnumber" placeholder="Reciever's account number" required>
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" name="amount" placeholder="Enter the amount" required>
            </div>
            <div class="mb-3">
                <input type="text" class="form-control" name="pin" placeholder="Enter the PIN" required>
            </div>
